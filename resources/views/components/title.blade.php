<div class="">
    <h2 class="text-3xl font-semibold text-dark dark:text-light lg:text-[40px]">{{ $page->title ?? '' }}</h2>
    <p class="mt-4 text-lg text-muted dark:text-light/70 lg:mt-6 lg:text-2xl">{{ $page->content ?? '' }}</p>
</div>
{{-- 
