            ...
            <div class="row">
                        ...
                        <div class="order-form-start">
                            <form action="{{ route('store') }}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    ...
                                    <select aria-label="Type of paper" name="type_of_paper" id="type_of_paper" required="required">
                                ...
                                <div class="form-group">
                                    ...
                                    <select aria-label="Paper Quality" name="paper_quality" id="paper_quality" oninvalid="setCustomValidity('Please select paper quality.')" oninput="setCustomValidity('')" required="required">
                                ...
                                <div class="policy-check">
                                    ...
                                    <p>By Checking This Box And Proceeding With This Order I Agree With Privacy Policy, Terms Of Use, Cookie Policy And Money Back Guarantee Of The Website. I Realise That All My Personal Data Being Used For Better Services Has Remained Safe.</p>
                                </div>
                                <div class="d-none">
                ...
                <div class="col-xl-4">
                    <div class="order-now-right">
                        ...
                        <div class="payment-and-security-card">
                            <div class="payment-card-header">
                                <img src="{{ asset('assets/images/payment-icon.webp') }}" width="45.618px" height="40.295px" loading="lazy" class="img-fluid" alt="payment">
                                <h4>Payment &amp; Security</h4>
                            </div>
                            <div class="payment-card-body">
                                <p>dissertation help online guarantee the privacy of all the customers and never share their personal information with third parties. For more details read our Privacy Policy customers and never share their personal information.</p>
                                <div class="payment-img-container">
                                    <img src="{{ asset('assets/images/payment-methods-icon.webp') }}" width="382.618px" height="149.133px" loading="lazy" class="img-fluid" alt="Payment Methods">
                                </div>
                                <div class="btns-container">
                                    <div class="payemnt-card-btn">
                                        <img src="{{ asset('assets/images/hidden-eye-icon.webp') }}" width="30px" height="30px" loading="lazy" class="img-fluid" alt="Hidden eye">
                                        <p>No Hidden Charges</p>
                                    </div>
                                    <div class="payemnt-card-btn">
                                        <img src="{{ asset('assets/images/pound-bg-black.webp') }}" width="30px" height="30px" loading="lazy" class="img-fluid" alt="Pound symble">
