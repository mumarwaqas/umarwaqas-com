...
@section('content')
                            ...
                            <div class="every-update-list-container">
                                <div class="list-container-title">
                                    <div class="img-container img-container-1">
                                        <img src="{{ asset('assets/images/sky-blue-bulb-icon.webp') }}" class="img-fluid" loading="lazy" height="40.9px" width="41px"  alt="Tips And Tricks">
                                    </div>
                            ...
                            <div class="every-update-list-container">
                                <div class="list-container-title">
                                    <div class="img-container img-container-2">
                                        <img src="{{ asset('assets/images/pink-bulb-icon.webp') }}" class="img-fluid" loading="lazy" height="40.9px" width="41px"  alt="Tips And Tricks">
                                    </div>
                                    <h5>Tips and Tricks</h5>
                                </div>
                                <div class="every-update-list">
                            ...
                            <div class="every-update-list-container">
                                <div class="list-container-title">
                                    <div class="img-container img-container-3">
                                        <img src="{{ asset('assets/images/purple-bulb-icon.webp') }}" class="img-fluid" loading="lazy" height="40.9px" width="41px"  alt="Tips And Tricks">
                                    </div>
                                    <h5>Tips and Tricks</h5>
                                </div>
                                <div class="every-update-list">
    ...
    <!-- ===================================================== -->
    <!-- ===============  Call To Action 3 section start ================ -->
    @include('partials.call-to-action-3')
    <!-- ===============  Call To Action 3 section end ================ -->
    <!-- ===================================================== -->
