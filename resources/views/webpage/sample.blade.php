                        ...
                        <div class="sample-preview-content">
                            ...
                            <div class="sample-details">
                                ...
                                <div class="sample-share-btns">
                                    <span>Share:</span>
                                    <a href="#"><img src="{{ asset('assets/images/facebook-social.webp') }}" class="img-fluid" height="26px" width="26px" loading="lazy" alt="Facebook"></a>
                                    <a href="#"><img src="{{ asset('assets/images/linkedin-social.webp') }}" class="img-fluid" height="24.9px" width="23.27px" loading="lazy" alt="Linkedin"></a>
                                    <a href="#"><img src="{{ asset('assets/images/instagram-social.webp') }}" class="img-fluid" height="27.19px" width="27.2px" loading="lazy" alt="Instagram"></a>
                                </div>
                            </div>
