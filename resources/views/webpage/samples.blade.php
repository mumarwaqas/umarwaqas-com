...
@section('inner_page_hero_section_samples_search')
Yes
@endsection 
                    ...
                    <div class="samples-carousel-page-container">
                        ...
                        <div class="samples-slider-container mb-4">
                            ...
                            <div class="samples-body">
                                <div class="sample-img">
                                    {{-- $sample['image'] --}}
                                    <img src="{{ $sample->image ? asset($sample->image) : asset('assets/images/sample-img-yellow.webp') }}" loading="lazy" class="img-fluid" width="154px" height="237px" alt="{{ $sample->name }}">
                        ...
                        <div class="pagination">
                            ...
                            @foreach ($samples->getUrlRange(1, $samples->lastPage()) as $key => $url)
                                @if ($key == $samples->currentPage())
