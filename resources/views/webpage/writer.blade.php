            ...
            <div class="row">
                ...
                <div class="col-xl-8">
                    <div class="writer-profile-right">
                        <div class="writer-free-feature-card">
                            <div class="writer-feature-header">
                                <div class="title">
                                    <h5>Free Features every order</h5>
                                </div>
                                <div class="special-offer-container">
                                    <img src="{{ asset('assets/images/white-star-icon.webp') }}" width="20px" height="20px" class="img-fluid" loading="lazy" alt="Star">
                                    <p><span>Special offer!</span> Save  <span>15%</span> on your first order</p>
                                </div>
                            </div>
                            <div class="writer-feature-body">
                                <div class="features-list-container">
                                    <div class="feature-list-row">
                                        <div class="feature-list">
                                            <div class="heading">Title Page</div>
                                            <div class="field-left">
                                                <div class="field-price">For <span>£4.50</span></div>
                                        ...
                                        <div class="feature-list">
                                            ...
                                            <div class="field-left">
                                                <div class="field-price">For <span>£10.50</span></div>
                                                <div class="free-badge">Free</div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="feature-list-row">
                                        <div class="feature-list">
                                            <div class="heading">Formatting</div>
                                            <div class="field-left">
                                                <div class="field-price">For <span>£10.50</span></div>
                                                <div class="free-badge">Free</div>
                                            </div>
                                        ...
                                        <div class="feature-list">
                                            <div class="heading">Additional Revisions</div>
                                            <div class="field-left">
                                                <div class="field-price">For <span>£10.50</span></div>
                                                <div class="free-badge">Free</div>
                                            </div>
                                    ...
                                    <div class="feature-list-row">
                                        ...
                                        <div class="feature-list">
                                            <div class="heading">Originality Check</div>
                                            <div class="field-left">
                                                <div class="field-price">For <span>£10.50</span></div>
                                                <div class="free-badge">Free</div>
                                            </div>
                            ...
                            <div class="writer-feature-footer">
                                <div class="heading-container">
                                    <p>Get all these features</p>
                                    <p class="content-bold">For  <span>£80.50</span> Free</p>
                                </div>
                                <div class="checkout-btn">
                                    <button type="button" onclick="window.location.href='{{ route('order-now') }}';">
                        ...
                        <div class="writer-user-reviews mt-4">
