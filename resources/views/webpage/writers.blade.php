                    ...
                    <div class="writers-carousel-container">
                        <div class="writers-carousel">
                            ...
                            <div class="pagination">
                                ...
                                @else
                                    <a href="{{ $writers->previousPageUrl() }}" class="prev" rel="prev"><img src="{{ asset('assets/images/angle-left-black.webp') }}" alt="angle-left-black" width="17" height="28"></a>
                                @endif
                                <div class="pages-number">
                                @foreach ($writers->getUrlRange(1, $writers->lastPage()) as $key => $url)
                                    @if ($key == $writers->currentPage())
                                ...
                                @if ($writers->hasMorePages())
                                    <a href="{{ $writers->nextPageUrl() }}" class="next" rel="next"><img src="{{ asset('assets/images/angle-right-black.webp') }}" alt="angle-right-black" width="17" height="28"></a>
                                @else
